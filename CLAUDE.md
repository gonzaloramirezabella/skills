...
| `write-handbook` | Productora de páginas de Handbook (docs de operación para admins). Tiene rutas del repo wdetail hardcodeadas; para otro repo hay que adaptarla. |
